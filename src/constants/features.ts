...
import { Package, DollarSign, TrendingUp, Bot, Download, Wrench } from 'lucide-react';
...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description: 'Pantau keuntungan harian, mingguan, dan bulanan secara real-time',
    icon: DollarSign
  },
  {
    id: 'analytics',
  ...
  },
  {
    id: 'support',
    title: '24/7 Support',
    description: 'Dukungan teknis 24 jam untuk memastikan bisnis berjalan lancar',
    icon: Wrench
  }
];
