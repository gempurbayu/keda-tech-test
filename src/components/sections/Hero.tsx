					...
					<div className="space-y-8">
						<div className="space-y-4">
							...
							<p className="text-xl text-gray-600 leading-relaxed">
								Solusi ERP lengkap untuk memudahkan pengusaha dalam mencatat
								barang masuk/keluar, menganalisis keuntungan, dan mengembangkan
								bisnis dengan teknologi terdepan.
							</p>
						</div>
